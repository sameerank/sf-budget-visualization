...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var JSONStore = __webpack_require__(169);
	var ApiUtil = __webpack_require__(192);
	
	var YearSelector = __webpack_require__(194);
	var NodeSelector = __webpack_require__(195);
	...
	var App = React.createClass({
	  ...
	  _visualizeGraph: function () {
	    ...
	    chart.nodeWidth(15).nodePadding(10).draw(this.state.graph);
	  },
	  ...
	  render: function () {
	    return React.createElement(
	      ...
	      React.createElement(
	        'h2',
	        null,
	        'Cash Flow in the San Francisco Budget'
	      ),
	      React.createElement(YearSelector, { year: this.state.year, updateYear: this._updateYear }),
	      React.createElement(
	        'div',
	        ...
	        React.createElement(
	          ...
	          React.createElement(NodeSelector, { selected: this.state.revenue,
	        ...
	        React.createElement(
	          ...
	          'Spending:',
	          React.createElement('br', null),
	          React.createElement(NodeSelector, { selected: this.state.spending,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var resetJSON = function (jsons, revenueNode, spendingNode) {
	  ...
	  _graph.nodes = d3.keys(d3.nest().key(function (d) {
	    return d.name;
	  }).map(_graph.nodes));
	...
	JSONStore.__onDispatch = function (payload) {
	  switch (payload.actionType) {
	    case Constants.JSON_RECEIVED:
	      resetJSON(payload.json, payload.revenueNode, payload.spendingNode);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ApiActions = __webpack_require__(193);
	
	var ApiUtil = {
	
	  fetchJSON: function (year, revenueNode, spendingNode) {
	    var url1 = "https://data.sfgov.org/resource/727n-u3zg.json?$select=fund," + revenueNode + ",sum(amount)&$where=revenue_or_spending%20=%20%27Revenue%27" + "&fiscal_year=" + year + "&$group=fund," + revenueNode;
	    var url2 = "https://data.sfgov.org/resource/727n-u3zg.json?$select=fund," + spendingNode + ",sum(amount)&$where=revenue_or_spending%20=%20%27Spending%27" + "&fiscal_year=" + year + "&$group=fund," + spendingNode;
	  ...
	  render: function () {
	    return React.createElement(
	      ...
	      React.createElement(
	        ...
	        null,
	        " Fiscal Year:",
	        React.createElement("input", { type: "range", min: "2010", max: "2017", onChange: this.handleChange,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var NodeSelector = React.createClass({
	  ...
	  render: function () {
	    return React.createElement(
	      'select',
	      { value: this.props.selected, onChange: this._handleChange },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var forOwn = __webpack_require__(198);
